...
namespace EITS
{
	VoxModel::VoxModel(void):width(2),height(2),depth(2),scale(1),size(1,1,1),is_loaded(false),is_viewData(true)
	{
		this->isMilling=false;
		this->is_auto_scale=true;
		this->is_viewSlice=false;
		this->curStimMap=0;
		this->freeLabel=0;
	...
	{
		if(!this->is_loaded||!this->is_viewData)
			return;
